...
- `agent/churn_recovery_agent.py`: Tensorlake Orchestrate Python app. It can be triggered manually over HTTP or scheduled every 15 minutes. Each run generates 1-3 realistic fake churned fastclip.it users, drafts founder-voice recovery emails, and writes everything to Turso.
